...
namespace OpenNos.Handler
{
    public class CommandPacketHandler : IPacketHandler
    {
        ...
        {
            Logger.LogUserEvent("GMCOMMAND", Session.GenerateIdentity(), "[Yardım]");
        ...
        public void CreateItem(CreateItemPacket createItemPacket)
        {
            ...
            {
                Logger.LogUserEvent("GMCOMMAND", Session.GenerateIdentity(),
                    $"[ItemUret]ItemVNum: {createItemPacket.VNum} Amount/Design: {createItemPacket.Design} Upgrade: {createItemPacket.Upgrade}");
                ...
                if (ServerManager.Instance.Configuration.UseLogService)
                {
                    LogServiceClient.Instance.LogPacket(new PacketLogEntry()
                    {
                        ...
                        SenderId = Session.Character.CharacterId,
                        PacketType = LogType.GMCommand,
                        Packet = $"[ItemUret]ItemVNum: {createItemPacket.VNum} Amount/Design: {createItemPacket.Design} Upgrade: {createItemPacket.Upgrade}"
                    });
                }
